...
export const clientsApi = {
  ...
  update: async (id, updates, userId) => {
    ...
    await logActivity(
      ...
      id,
      "updated",
      `Updated client ${data.client_name}`,
    );
    return data;
  },
...
export const getDashboardStats = async (userId) => {
  ...
  const stats = {
    ...
    pendingProjects: clients.filter(
      (c) =>
        c.project_status === "pending" || c.project_status === "in_progress",
    ).length,
    completedProjects: clients.filter((c) => c.project_status === "completed")
      .length,
